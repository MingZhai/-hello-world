...
public class VSInvocationHandler implements InvocationHandler, Serializable {
	...
	public Object invoke(Object proxy, Method method, Object[] args)
		...
		VSSenMsg senMsg = new VSSenMsg(remote.getObjectID(),
				method.toGenericString(), toSend);

//		if (socket.isBound()) {   //for test
//			// System.out.println("invocationhandler invoke socket is bound " +
//			// remote.getHost() + " " + remote.getPort()); //local port
//			// socket.getLocalPort()
//		}
